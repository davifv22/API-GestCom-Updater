...
class Versao(db.Model):
    ...
    tipo_sistema = db.Column(db.Integer, primary_key=True, nullable=False) # 0 - MGF | 1 - PRO | 2 - RECEBIMENTO
    ...
    link_downloaded = db.Column(db.String(100), nullable=False) # # URL_API/versao/download/MGFAtualização_7008.rar
